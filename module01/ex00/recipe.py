class Recipe:
    def __init__(self, name, cooking_lvl, cooking_time,
        ...
        elif isinstance(cooking_lvl, int) is False or \
                cooking_lvl < 1 or cooking_lvl > 5:
            raise ValueError("error: level must be an int between 1 and 5")
        ...
        elif isinstance(name, str) is False or \
                (recipe_type != "starter" and
                 recipe_type != "lunch" and recipe_type != "dessert"):
